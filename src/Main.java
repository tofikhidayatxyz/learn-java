...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\n====== Cari berdasarkan kata inggrisr ======");
        ...
        Word customSearch2 = search.searchFromEnglish(0, search.words.size(), keyWord1);
        ...
        String keyWord3 = "mobil";
        Word customSearch3 = search.searchFromEnglish(0, search.words.size(), keyWord3);

        if(customSearch3 != null) {
            printWord(customSearch3, keyWord2);
        } else {
            System.out.println("Kata '"+ keyWord2 +"' Tidak Di temukan");
        }
